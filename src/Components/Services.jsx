    ...
    return (
        <div className="py-12 px-4 bg-gray-50">
            ...
            <div className="flex flex-row flex-wrap justify-center w-full gap-8">
                <div className="p-8 w-[20%] rounded-lg shadow-lg hover:shadow-xl">
                    <IoHomeOutline className="text-blue-700 text-3xl mb-6" />
                    <h3 className="text-2xl text-blue-700 mb-4 font-bold">Home Loan</h3>
                    ...
                    <button className="text-[14px] text-blue-700 font-bold">Learn More →</button>
                </div>

                <div className="p-8 w-[20%] rounded-lg shadow-lg hover:shadow-xl">
                    <FiUsers className="text-blue-700 text-3xl mb-6" />
                    <h3 className="text-2xl text-blue-700 mb-4 font-bold">Education Loan</h3>
                ...
                <div className="p-8 w-[20%] rounded-lg shadow-lg hover:shadow-xl">
                    <PiSuitcase className="text-blue-700 text-3xl mb-6" />
                    <h3 className="text-2xl text-blue-700 mb-4 font-bold">Business Loan</h3>
                ...
                <div className="p-8 w-[20%] rounded-lg shadow-lg hover:shadow-xl">
                    <FiUser className="text-blue-700 text-3xl mb-6" />
                    <h3 className="text-2xl text-blue-700 mb-4 font-bold">Personal Loan</h3>
                ...
                <div className="p-8 w-[20%] rounded-lg shadow-lg hover:shadow-xl">
                    <FiCreditCard className="text-blue-700 text-3xl mb-6" />
                    <h3 className="text-2xl text-blue-700 mb-4 font-bold">Gold Loan</h3>
                ...
                <div className="p-8 w-[20%] rounded-lg shadow-lg hover:shadow-xl">
                    <FaCar className="text-blue-700 text-3xl mb-6" />
                    <h3 className="text-2xl text-blue-700 mb-4 font-bold">Car Loan</h3>
                ...
                <div className="p-8 w-[20%] rounded-lg shadow-lg hover:shadow-xl">
                    <FiShield className="text-blue-700 text-3xl mb-6" />
                    <h3 className="text-2xl text-blue-700 mb-4 font-bold">Credit Card</h3>
                ...
                <div className="p-8 w-[20%] rounded-lg shadow-lg hover:shadow-xl">
                    <IoHomeOutline className="text-blue-700 text-3xl mb-6" />
                    <h3 className="text-2xl text-blue-700 mb-4 font-bold">Loan Against Property</h3>
                ...
                <div className="p-8 w-[20%] rounded-lg shadow-lg hover:shadow-xl">
                    <FaStarOfLife className="text-blue-700 text-3xl mb-6" />
                    <h3 className="text-2xl text-blue-700 mb-4 font-bold">Life Insurance</h3>
                    ...
                    <button className="text-[14px] text-blue-700 font-bold">Starting from ₹ 450/month* →</button>
                </div>

                <div className="p-8 w-[20%] rounded-lg shadow-lg hover:shadow-xl">
                    <MdHealthAndSafety className="text-blue-700 text-3xl mb-6" />
                    <h3 className="text-2xl text-blue-700 mb-4 font-bold">Health Insurance</h3>
                ...
                <div className="p-8 w-[20%] rounded-lg shadow-lg hover:shadow-xl">
                    ...
                    <h3 className="text-2xl text-blue-700 mb-4 font-bold">General Insurance</h3>
