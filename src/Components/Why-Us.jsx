...
export function WhyUS() {
    ...
    return (
        <>
            ...
            <div className="flex min-b:flex-row max-b:flex-col justify-center items-center gap-5 py-5 min-g:px-10 max-g:px-5">
                <div className="rounded-lg shadow-lg hover:shadow-2xl duration-300 min-a:w-[44%] max-a:w-[49%]
                    max-b:w-full min-g:p-8 max-g:p-4">
                    ...
                    <p className="text-[16px] text-gray-700 mt-4 min-d:mb-6 max-d:mb-5">It's simple — help others get the financial support
                ...
                <div className="rounded-lg shadow-lg hover:shadow-2xl duration-300 min-a:w-[44%] max-a:w-[49%]
                    max-b:w-full min-g:p-8 max-g:p-4">
                    <h2 className="font-bold pb-2.5 border-b-2 border-gray-300 text-blue-900 min-d:text-2xl 
                        max-d:text-[20px] min-d:mb-5 max-d:mb-3">
                        Become A Partner</h2>
